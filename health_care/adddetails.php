  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      ...
      <div class="p-4 pt-5">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li>
            <a onclick="changeContent('prescription')">Upload Prescription</a>
          </li>

          <li>
            <a onclick="changeContent('lab')">Upload Lab Report</a>
          </li>
    ...
    <div id="content" class="p-0 p-md-0 pt-0">
        ...
        <section class="login-clean">
          <form method="post">
            ...
            <div class="mb-3 ">
              ...
              <button class="btn btn-primary d-block w-100 " type="button" style="background-color: black; " onclick="generate_password(<?php echo $pid; ?>);">Generate Password</button>
            </div>
          </form>
      ...
      <ul class="list-group">
        ...
        ?>
         <li class="list-group-item m-10" aria-current="true"  ><a href="<?php echo $path; ?>"><?php echo $files[$i]; ?></a></li>
